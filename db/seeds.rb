...
Product.create!(genre_id: 1, name: "test", introduction: "test", price: 1000, is_active: true, image: File.open("app/assets/images/noimage.jpg"))
Product.create!(genre_id: 1, name: "test2", introduction: "test2", price: 1000, is_active: true, image: File.open("app/assets/images/noimage.jpg"))
